    ...
    return (
        <div className="header">
            ...
            <div className="middle-left">
                ...
                <p>Hi, my name is Kerry<br></br> McPhearson & I’m a <br></br>  Product Designer Hailing <br></br> From Atlanta, GA</p>
                </div>
                <div className="layer-two">
                <img src={MiddleLeft}></img>
                </div></div>

            <div className="middle-front"><img src={MiddleFront}></img></div> 
            <div className="middle-behind"><img src={MiddleBehind}></img></div> 
